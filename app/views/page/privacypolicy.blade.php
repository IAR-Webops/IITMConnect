		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 col-md-offset-2 col-md-8">
		          ...
		          <hr>		       
					<p>This Privacy Policy governs the manner in which IITMConnect collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://iitmconnect.iitmadras.in/">http://iitmconnect.iitmadras.in/</a> website ("Site").</p>
					...
					<p>IITMConnect may collect and use Users personal information for the following purposes:</p>
					<ul>
					  <li>
					...
					<p>IITMConnect has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>

					<h3>Your acceptance of these terms</h3>
					<p>By using this Site, you signify your acceptance of this policy. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes. </p>

					<h3>Contacting us</h3>
					<p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact Abhishek Sharma at <a href="mailto:sec_iar@smail.iitm.ac.in?Subject=Privacy%20Policy">sec_iar@smail.iitm.ac.in</a>.</p>

					<p>This document was last updated on May 27, 2015
					<br>Privacy policy created by <a href="http://www.generateprivacypolicy.com" target="_blank">GeneratePrivacyPolicy.com</a></p>
