...
@section('content')
    ...
    @include('layout.login-top')
        ...
        <div id="bg">
			<img src="{{ URL::asset('img/iitmconnect_bg.jpg') }}" alt="">
		</div>
			    			...
			    			<div class="login-form">
								...
								<div class="row">
									...
									<h4>
										...
										|
										<a href="{{ URL::route('report-issues') }}" target="_alt" style="color: #ECF0F1">
								...
								<p class="text-center">Kindly disable Ad Blockers if you face Sign In Issues</p>
